...
//icon
import { PanelBottomOpen, PanelTopOpen, ArrowLeft } from "lucide-react";
        ...
        <div className="w-full h-full flex flex-col bg-olive-100 overflow-hidden">
            ...
            <div className="flex flex-row p-2 gap-4 justify-between items-center border-b bg-olive-50">
                <div className="flex flex-row gap-4 items-center">
                    ...
                    <h2 className="font-semibold text-lg text-olive-800">
                        Flow Order
                    </h2>
            ...
            <div className="flex-1 flex h-full relative overflow-hidden">
                {/* BUNGKUS KEDUANYA DENGAN SATU PROVIDER SAJA */}
                <ReactFlowProvider>
                    {/* Canvas Area */}
                    ...
                    {/* Right Panel (Sidebar Konfigurasi) */}
                    {selectedNode && (
            ...
            <div
                className={`w-full h-fit border-t border-olive-900 bg-white transition-all duration-300 ease-in-out flex flex-col ${isBottomOpen ? "h-48" : "h-10"}`}
            >
                <div className="flex flex-row w-full h-fit p-2 justify-between">
                    ...
                    >
                        <span className="text-xs text-olive-700 font-medium">
                            {isBottomOpen ? (
