    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            ...
            setErrorPopup({
                ...
                message:
                    err.message ||
                    "Email tidak ditemukan atau format tidak valid.",
                errors: err.errors || null,
            });
        } finally {
            setIsLoading(false);
        ...
        >
            ...
            <div className="flex-1 flex justify-center items-center px-5 py-10 relative z-1">
                <div className="w-105 p-8.75 flex flex-col justify-center gap-5 rounded-[10px] border-[3px] border-(--main-color) bg-[#f0f0f0] shadow-[8px_8px_var(--main-color)]">
                    ...
                    <div className="text-[28px] font-black text-center text-(--main-color)">
                        Forgot your password?
                    </div>
                    ...
                    >
                        <input
                            className="w-full h-13 rounded-lg border-[3px] border-(--main-color) bg-(--bg-color) shadow-[6px_6px_var(--main-color)] text-lg font-semibold text-(--font-color) px-3.75 outline-none box-border placeholder:text-(--font-color-sub) placeholder:opacity-80 focus:border-(--input-focus)"
                            name="email"
                        ...
                        />
                        <button
                            className="w-full h-13 rounded-lg border-[3px] border-(--main-color) bg-(--bg-color) shadow-[6px_6px_var(--main-color)] text-xl font-semibold text-(--font-color) cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed active:shadow-[0px_0px_var(--main-color)] active:translate-x-1 active:translate-y-1"
                            type="submit"
                            disabled={isLoading}
                        >
                    ...
                    <button
                        ...
                        className="bg-transparent border-none p-0 cursor-pointer text-sm font-semibold text-(--input-focus) underline text-center hover:opacity-80"
                    >
                        Back to Login
                    </button>
                </div>
